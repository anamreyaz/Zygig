  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-gray-900 via-[#09090B] to-gray-900">
        {/* Header Section */}
        <header
          className="h-screen flex flex-col justify-center items-center text-white text-center -mt-16"
          data-aos="fade-up"
        >
          ...
          <button
            ...
            className="absolute bottom-10 flex flex-col items-center text-gray-300 hover:text-gray-400 hover:underline p-2 rounded transition duration-300 "
          >
